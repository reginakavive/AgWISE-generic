...
worldclim_bioc<- function(var, res, pathOut,country, raster = TRUE, coords = NULL){
  
  #define function elements and paths
  #downloaded file path
  ifelse(!dir.exists(file.path("./geodata3/")), dir.create(file.path("./geodata3/")), FALSE)
  url<-"./geodata3/"
  #url<-"datadownload/"
...
#worldclim_bioc('bio', 10, "D:/Work/EiA/AgWISE-generic/geodata", "Rwanda", TRUE, NULL)
...
worldclim_future <- function(var, res,  ssp, model, period, country,pathOut,  raster = TRUE, coords = NULL){
  #define function elements and paths
  #downloaded file path
...
#                  country= 'Kenya',"D:/Work/EiA/AgWISE-generic/geodata",  raster = TRUE, coords = NULL)
